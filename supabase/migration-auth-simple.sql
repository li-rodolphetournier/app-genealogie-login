-- ============================================
-- SCRIPT SIMPLIFIÉ DE MIGRATION VERS SUPABASE AUTH
-- Version qui évite les modifications de type de colonne
...
-- Désactiver RLS et supprimer toutes les politiques
DO $$ 
BEGIN
...
-- ============================================
-- ÉTAPE 1 : Supprimer password_hash uniquement
-- ============================================
...
-- Ajouter la référence à auth.users si possible
DO $$ 
BEGIN
    ...
    IF EXISTS (
        ...
        IF NOT EXISTS (
            ...
            EXCEPTION WHEN OTHERS THEN
                -- Ignorer l'erreur si la contrainte existe déjà ou si auth.users n'existe pas
                NULL;
            END;
        END IF;
    END IF;
