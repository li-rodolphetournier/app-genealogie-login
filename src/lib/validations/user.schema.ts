...
export const userCreateSchema = z.object({
  ...
  status: z.enum(['administrateur', 'utilisateur', 'redacteur'] as const, {
    message: 'Le statut doit être administrateur, utilisateur ou redacteur'
  }),
...
export const userUpdateSchema = z.object({
  ...
  status: z.enum(['administrateur', 'utilisateur', 'redacteur'] as const).optional(),
  nom: z.string().optional(),
  prenom: z.string().optional(),
  dateNaissance: z.string().optional(),
