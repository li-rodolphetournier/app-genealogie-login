...
export default function CreateObject() {
    ...
    return (
      <main role="main" className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Créer un nouvel élément de patrimoine</h1>
          <div>Chargement...</div>
        </div>
      </main>
    );
          ...
          <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                Seuls les administrateurs ou rédacteurs peuvent créer des éléments de patrimoine.
              </p>
              <button
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!user) {
      setError('Vous devez être connecté pour créer un élément de patrimoine');
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json().catch(() => ({}));
        throw new Error(errorData.error || 'Erreur lors de la création de l\'élément de patrimoine');
      }
    ...
    <PageTransition>
      <main role="main" className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Créer un nouvel élément de patrimoine</h1>
            ...
            <div className="space-y-6">
              <div>
                <label htmlFor="nom" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Nom de l'élément de patrimoine
                </label>
                <input
                  type="text"
                  id="nom"
                  ...
                  placeholder="Saisissez le nom de l'élément de patrimoine"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400"
                  placeholder="Description brève de l'élément de patrimoine"
                />
              </div>
